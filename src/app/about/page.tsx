      ...
      <section className="section-padding bg-gray-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { name: "Suleiman M. Rashid", role: "Managing Director", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80" },
              { name: "Zuhura J. Khalfan", role: "Operations Manager", img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&q=80" },
              { name: "Bakari S. Omari", role: "Head of Construction", img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&q=80" },
              { name: "Fatma H. Said", role: "Logistics Coordinator", img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&q=80" },
            ].map((m, i) => (
              <div key={m.name} className={`group bg-white rounded-3xl overflow-hidden shadow-lg border border-gray-100 hover:border-brand-gold transition-all duration-500 animate-fade-in-up animation-delay-${(i + 1) * 100}`}>
